...
namespace CarFactoryAPI_Tests
{
    public class OwnersServiceTests : IDisposable
    {
        ...
        public void BuyCar_HaveCar_Alreadyhavecar()
        {
            ...
            // Build the mock Data
            Car car = new Car() { Id = 10, Price = 1000 };
            Owner owner = new Owner() { Id=5,  Car = new Car()};
        ...
        public void BuyCar_CheckPrice_Insufficient()
        {
            ...
            BuyCarInput carInput = new() { CarId = 10, OwnerId = 8, Amount = 1000 };
        ...
        public void BuyCar_AssigntoOwner_SomethingWrong()
        {
            ...
            // Build the mock Data
            Car car = new Car() { Id = 10, Price = 10000 };
            Owner owner = new Owner() { Id = 9 };

            // Setup called methods
            carRepoMock.Setup(o => o.GetCarById(10)).Returns(car);
            OwnerRepoMock.Setup(o => o.GetOwnerById(9)).Returns(owner);
            BuyCarInput carInput = new() { CarId = 10, OwnerId = 9, Amount = 100000 };
        ...
        public void BuyCar_AssigntoOwner_Successful()
        {
            ...
            // Build the mock Data
            Car car = new Car() { Id = 10, Price = 10000, OwnerId=9};
            Owner owner = new Owner() { Id = 9 };

            // Setup called methods
            carRepoMock.Setup(o => o.GetCarById(10)).Returns(car);
            OwnerRepoMock.Setup(o => o.GetOwnerById(9)).Returns(owner);
            carRepoMock.Setup(o => o.AssignToOwner(11, 15)).Returns(true);
